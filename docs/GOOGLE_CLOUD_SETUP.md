...
gcloud run deploy civicguide-web `
  ...
  --region us-central1 `
  --allow-unauthenticated `
  --set-env-vars="NEXT_PUBLIC_FIREBASE_API_KEY=[REDACTED],NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=promptwar-cddf1.firebaseapp.com,NEXT_PUBLIC_FIREBASE_PROJECT_ID=promptwar-cddf1,NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=promptwar-cddf1.firebasestorage.app,NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID=1072664273807,NEXT_PUBLIC_FIREBASE_APP_ID=1:1072664273807:web:9c7d9e7917ac01f5d8a1fa,NEXT_PUBLIC_FIREBASE_VAPID_KEY=[REDACTED_VAPID_KEY],NEXT_PUBLIC_GOOGLE_MAPS_API_KEY=[REDACTED],GEMINI_API_KEY=[REDACTED_GEMINI_API_KEY],AGENT_SERVICE_URL=$AGENT_URL" `
  --memory 1Gi `
  --cpu 1 `
  --timeout 3600
```
